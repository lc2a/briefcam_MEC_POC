...
class FrontEnd:
    ...
    def check_for_new_documents_and_post_to_kafka(self):
        ...
        if type(message) is str:
            logging_to_console_and_syslog("Sending {} to kafka.".format(message))
            self.kafka_producer_instance.post_filename_to_a_kafka_topic(message)
        else:
            logging_to_console_and_syslog("Invalid message type={},message={},discarding it.."
